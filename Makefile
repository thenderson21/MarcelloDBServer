...
EXTRA_DIST =  rules.make configure Makefile.include ../../../../../MarcelloDB ../../../../../MarcelloDB.netfx ../../../../../CommandLine ../../../../../Newtonsoft.Json ../../../../../nunit.framework
...
ifeq ($(CONFIG),DEBUG_X86)
 SUBDIRS =  MarcelloDB.Server MarcelloDB.Tests MarcelloDB.Client
endif
